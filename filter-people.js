...
async function getPeopleFromLdap(){
  ...
  var staff = await client.search(base, {filter:"(|(ou=E0:LB-Univ Librarian-General*)(ou=E0:LB-Central Svcs*)(ou=E0:LB-User Svcs*)(&(ou=E0:LB-Info Technology)(!(uvaPersonFoundationName=Judge Advocate General School))))", scope:'sub'});
